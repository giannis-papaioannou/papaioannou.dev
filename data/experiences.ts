...
export const experiences: ExperienceCategory[] = [
  {
    ...
    points: [
      ...
      "Designed and delivered end-to-end full-stack systems for OPAP’s sports and racing channels, leveraging Django & FastAPI on the back end and React on the front end.",
